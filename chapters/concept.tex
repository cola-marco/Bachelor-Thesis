...
ROV-1 & Il sistema deve utilizzare i prodotti della suite \emph{Elastic Stack}
...
\begin{itemize}
    ...
    \item \textbf{RUM Agent JavaScript:} agente di monitoraggio \gls{rumg} eseguito nel \emph{frontend} dell'applicazione, che raccoglie dati sulle interazioni utente, sui tempi di caricamento delle pagine e sulle prestazioni percepite nel \emph{browser};
