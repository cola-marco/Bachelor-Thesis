...
\begin{description}
    ...
    \item[{\hyperref[cap:product-development]{Il quinto capitolo}}] approfondisce lo sviluppo del prodotto, descrivendo le fasi di implementazione, i risultati ottenuti e le difficoltà incontrate;

    \item[{\hyperref[cap:conclusioni]{Nel sesto capitolo}}] viene descritta l'esperienza complessiva dello stage, con una riflessione sui risultati raggiunti e le competenze acquisite, oltre a suggerimenti per possibili sviluppi futuri del progetto.
\end{description}
