...
Durante lo \emph{stage} è stato analizzato il \emph{Model Context Protocol}\footcite{site:mcp} (\gls{mcpg}), uno standard progettato per integrare modelli di intelligenza artificiale con strumenti esterni. \\
